    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rooms.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" type="number" name="unit" id="unit" value="{{ old('unit', '') }}" step="1">
                @if($errors->has('unit'))
                    <div class="invalid-feedback">
                        {{ $errors->first('unit') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resident_rate') ? 'is-invalid' : '' }}" type="number" name="resident_rate" id="resident_rate" value="{{ old('resident_rate', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('non_resident_rate') ? 'is-invalid' : '' }}" type="number" name="non_resident_rate" id="non_resident_rate" value="{{ old('non_resident_rate', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_type') ? 'is-invalid' : '' }}" type="text" name="room_type" id="room_type" value="{{ old('room_type', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('destination_id') ? 'is-invalid' : '' }}" type="number" name="destination_id" id="destination_id" value="{{ old('destination_id', '') }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image') ? 'is-invalid' : '' }}" type="image" name="image" id="image" value="{{ old('image', '') }}" >
                @if($errors->has('image'))
                    <div class="invalid-feedback">
                        {{ $errors->first('image') }}
                    </div>
